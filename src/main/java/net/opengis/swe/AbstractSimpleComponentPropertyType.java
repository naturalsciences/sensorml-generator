 ...
 *         &lt;element ref="{http://www.opengis.net/swe/2.0}AbstractSimpleComponent"/>
 *       &lt;/sequence>
...
public class AbstractSimpleComponentPropertyType {

    @XmlElementRef(name = "AbstractSimpleComponent", namespace = "http://www.opengis.net/swe/2.0", type = JAXBElement.class, required = false)
    protected JAXBElement<? extends AbstractSimpleComponentType> abstractSimpleComponent;
    ...
    public void setAbstractSimpleComponent(JAXBElement<? extends AbstractSimpleComponentType> value) {
        this.abstractSimpleComponent = value;
    }
