...
@XmlSeeAlso({
    net.opengis.sensorml.CapabilityListType.Capability.class,
    net.opengis.sensorml.CharacteristicListType.Characteristic.class,
    net.opengis.swe.DataStreamType.ElementType.class,
