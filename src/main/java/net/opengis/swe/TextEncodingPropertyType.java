...
/**
 * <p>Java class for TextEncodingPropertyType complex type.
 * 
...
@XmlType(name = "TextEncodingPropertyType", propOrder = {
    "textEncoding"
})
public class TextEncodingPropertyType {

    @XmlElement(name = "TextEncoding")
