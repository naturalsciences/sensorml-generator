...
/**
 * <p>Java class for AbstractModesPropertyType complex type.
 * 
...
@XmlType(name = "AbstractModesPropertyType", propOrder = {
    "abstractModes"
})
public class AbstractModesPropertyType {

    @XmlElementRef(name = "AbstractModes", namespace = "http://www.opengis.net/sensorml/2.0", type = JAXBElement.class, required = false)
