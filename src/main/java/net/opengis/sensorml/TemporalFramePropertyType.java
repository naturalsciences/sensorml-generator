...
/**
 * <p>Java class for TemporalFramePropertyType complex type.
 * 
...
@XmlType(name = "TemporalFramePropertyType", propOrder = {
    "temporalFrame"
})
public class TemporalFramePropertyType {

    @XmlElement(name = "TemporalFrame")
