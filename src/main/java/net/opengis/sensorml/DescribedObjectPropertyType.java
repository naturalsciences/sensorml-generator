 ...
 *         &lt;element ref="{http://www.opengis.net/sensorml/2.0}DescribedObject"/>
 *       &lt;/sequence>
...
public class DescribedObjectPropertyType {

    @XmlElementRef(name = "DescribedObject", namespace = "http://www.opengis.net/sensorml/2.0", type = JAXBElement.class, required = false)
    protected JAXBElement<? extends DescribedObjectType> describedObject;
