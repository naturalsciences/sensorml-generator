...
/**
 * <p>Java class for SpatialFramePropertyType complex type.
 * 
...
@XmlType(name = "SpatialFramePropertyType", propOrder = {
    "spatialFrame"
})
public class SpatialFramePropertyType {

    @XmlElement(name = "SpatialFrame")
